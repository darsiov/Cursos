#Pomodoro es un sistema para que administres el tiempo mientras trabajas, consiste en colocar un temporizador de 25 minutos y descansar 5 minutos, repetir el ciclo 4 veces y posterior aumentar el tiempo de descanso o directamente parar.  
import time 
import winsound
